...
?>
                                            ...
                                            <div class="col-md-6">
                                                <label for=""><small><strong>Chemist Shop Name*</strong></small></label>
                                                <div class="input-group mb-5">
                                                    <div class="input-group-prepend">
                                                        <span class="basic-addon1"></span>
                                                        <input type="text" name="Party_Name" class="form-control"
                                                            placeholder="Enter Chemist Shop Name" aria-label="Username"
                                            ...
                                            <div class="col-md-6">
                                                <label for=""><small><strong>Contact Person
                                                ...
                                                <div class="input-group mb-5">
                                                    <div class="input-group-prepend">
                                                        ...
                                                        <input name="GSTIN" type="text" class="form-control"
                                                            ...
                                                            aria-describedby="basic-addon1" id="gst_number"
                                            ...
                                            <div class="col-md-6">
                                                <label for=""><small><strong>Drug License Form No.
                                                            20*</strong></small></label>
                                                <div class="input-group mb-5">
                                                    <div class="input-group-prepend">
                                                        <span class="basic-addon1"></span>
                                                        <input name="DL_No"  id="DL_No" type="text" class="form-control"
                                                            placeholder="Drug License Form No. 20" aria-label="Username"
                                                            aria-describedby="basic-addon1" required autofocus>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label for=""><small><strong>Drug License Form No.
                                                            21*</strong></small></label>
                                                <div class="input-group mb-5">
                                                    <div class="input-group-prepend">
                                                        <span class="basic-addon1"></span>
                                                        <input name="DL_No_21" id="DL_No_21" type="text" class="form-control"
                                                            placeholder="Drug License Form No. 21" aria-label="Username"
                                                            aria-describedby="basic-addon1" required autofocus>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label for=""><small><strong>Drug Licence Form 20 File* <br>(Accept Only
                                                            Image Or PDF
                                                            File)</strong></small></label>
                                                <div class="input-group mb-5">
                                                    <div>
                                                        <span class="basic-addon1"></span>
                                                        <input name="DL_File" id="DL_File" type="file" class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                <label for=""><small><strong>Drug Licence Form 21 File* <br>(Accept Only
                                                            Image
                                                            Or PDF
                                                            File)</strong></small></label>
                                                <div class="input-group mb-5">
                                                    <div>
                                                        <span class="basic-addon1"></span>
                                                        <input name="DL_File_21" id="DL_File_21" type="file" class="form-control"
                                                            placeholder="Enter Drug Licence" aria-label="Username"
                                                            aria-describedby="basic-addon1" required autofocus>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <label for=""><small><strong>Drug License Form 20 Valid
                                                            From*</strong></small></label>
                                                <div class="input-group mb-5">
                                                    <div class="input-group-prepend">
                                                        <span class="basic-addon1"></span>
                                                        <input name="DL_Valid_From" id="DL_Valid_From" type="date" class="form-control"
                                                            placeholder="Drug License Form No. 20" aria-label="Username"
                                                            aria-describedby="basic-addon1" required autofocus>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <label for=""><small><strong>Drug License Form 21 Valid From
                                                            21*</strong></small></label>
                                                <div class="input-group mb-5">
                                                    <div class="input-group-prepend">
                                                        <span class="basic-addon1"></span>
                                                        <input name="DL_Valid_From_21" id="DL_Valid_From_21" type="date" class="form-control"
                                                            placeholder="Drug License Form No. 21" aria-label="Username"
                                                            aria-describedby="basic-addon1" required autofocus>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <label for=""><small><strong>BD Code (Optional)</strong></small></label>
                                                <div class="input-group mb-5">
                                                    <div class="input-group-prepend">
                                                        <span class="basic-addon1"></span>
                                                        <input name="Referral_Code" id="Referral_Code" type="text" class="form-control"
                                                            placeholder="Referral Code" aria-label="Referral_Code"
                                                            aria-describedby="basic-addon1" required autofocus>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div id="opt-reg-sec" style="display:none">
                                        ...
                                        <a href="javascript:void(0);" id="chemist_register_generate_resend_otp">Resend
                                            OTP</a>
                                    </div>
    ...
    function gst_check() {
        ...
        if (gstinVal.length == 15) {
            ...
            if (reggst.test(gstinVal)) {
                ...
                $("#gst_check_message").val(gstinVal);
                $("#gst_number").focus();
            }
        }
    }
