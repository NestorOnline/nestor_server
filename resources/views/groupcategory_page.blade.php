...
?>
                <ul class="pagination">
                    ...
                    @else
                    <li><a
                            href="{{route('frontend.groupcategory_page',[$single_group->url_name,$single_groupcategory->url_name])}}?page={{$prev}}">Prev</a>
                    </li>
                    @endif
...
?> @if($active=="$x" ) <li class="active"><a
                            href="{{route('frontend.groupcategory_page',[$single_group->url_name,$single_groupcategory->url_name])}}?page={{$x}}">{{$x}}</a>
                        </li>
                        @else
                        <li><a
                                href="{{route('frontend.groupcategory_page',[$single_group->url_name,$single_groupcategory->url_name])}}?page={{$x}}">{{$x}}</a>
                        ...
                        @else
                        <li><a
                                href="{{route('frontend.groupcategory_page',[$single_group->url_name,$single_groupcategory->url_name])}}?page={{$next}}">Next</a>
                        </li>
                        @endif
                </ul>
                @endif
...
function slider_submit() {
    ...
    alert(maxval);
    $.ajax({
        url: "/search/groupcategory_product_by_price",
        data: {
            minval: minval,
            maxval: maxval,
