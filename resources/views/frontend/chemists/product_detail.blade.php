...
?>
                                                ...
                                                @else
                                                <input type="number" class="form-control" id="pincode_value"
                                                    value="110001" placeholder="Enter delivery pincode" maxlength="6"
...
?>
                                                <span class="input-group-text" id="pincode_check_data"
                                                    style="color: #003579;"><a class="font-14">Delivery by
                                                        {{date("M D", strtotime("+2  day"))}} | Delivery Charge
                                                        : Free</a></span>
                                                @else
                                                <span class="input-group-text" id="pincode_check_data"
                                                    style="color: #003579;"><a class="font-14">Delivery by
...
?>
                        ...
                        <div class="col-md-10">
                            ...
                            <p class="m-0">
                                <b>
                                    @if($prod->chemist_price->Price)
                                    Purchase Price: <em class="fa fa-inr"></em>{{$prod->chemist_price->Price}}
                                    @endif
                                </b>
                            </p>
                        </div>
  ...
  text-overflow: ellipsis;height: 25px">Packing : {{$package->name}}</span>
                        ...
                        <div class="diag-price" style="height: 30px;" style="">
                            <span class="price" style="color:black">
                                ...
                                MRP
                                <i class="fa fa-inr"></i>
                                {{number_format($prod->mrp_price->Price, 2, '.', ',')}}
                                @endif
                            </span>
                        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-2 ">
                <button type="button" class="add-to-cart"
                    onclick="add_cart_from_search({{$product->id}},{{$product->chemist_price->Price}},1,0)">Add to
                    Cart</button>
            </div>
        </div>
    </div>
