                                    ...
                                    <div class="product-details">
                                        <div class="steps-from">
                                            <ul class="steps-ul list-unstyled">
                                                ...
                                                @if($order->CancelOn)
                                                <li class="active li2">Ordered <span>{{$order->CancelOn->format('D')}}
...
$date1 = '';
if ($order->PackedOn) {
    $date1 = date('Y-m-d', strtotime("+1 day", strtotime($order->PackedOn)));
} elseif ($order->DispatchedOn) {
    $date1 = date('Y-m-d', strtotime("+1 day", strtotime($order->DispatchedOn)));
} elseif ($order->DeliveredOn) {
    $date1 = date('Y-m-d', strtotime("+1 day", strtotime($order->DeliveredOn)));
} else {
    $date1 = date('Y-m-d', strtotime("+1 day", strtotime($order->created_at->format('Y-m-d'))));
}
?>
                                                @if($order->PackedOn)
                                                <li class="active li2">
                                                ...
                                                @else
                                                <li class="li2">
                                                    Packed <span>{{date("D", strtotime($date1))}}
                                                        {{date("d", strtotime($date1))}}
                                                        {{date("M", strtotime($date1))}}</span></li>
                                                @endif
                                                ...
                                                @else
                                                <li class="li3">
                                                    Shipped <span>{{date("D", strtotime($date1))}}
                                                        {{date("d", strtotime($date1))}}
                                                        {{date("M", strtotime($date1))}}</span></li>
                                                @endif
                                                ...
                                                @else
                                                <li class="li4">
                                                    Delivered <span> Expected by, {{date("D", strtotime($date1))}}
                                                        {{date("d", strtotime($date1))}}
                                                        {{date("M", strtotime($date1))}} </span></li>
                                                @endif
                                                @endif
                        ...
                        <div class="deliveryby row m-0 mt-2">
                            <div class="remove-drug col-12 p-0 text-right">
                                <center>
                                    ...
                                    <a class="removeitem"
                                        href="{{route('backend.add_to_carts.re_order',$order->id)}}">Re-Order</a>
                                </center>
                            </div>
                        </div>
                        @else
