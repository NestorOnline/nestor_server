                                ...
                                <div>
                                    ...
                                    <form action="{{url('/loginpage_password')}}" method="post">
                                        <div class="input-group mb-5">
                                            ...
                                            <input type="hidden" id="facebook_user_id" class="form-control" value="{{$facebook_user_id}}">
                                            </div>
                                        </div>
                                    </form>
                                    <div style="display:none" id="otp-div">                                       
                                        ...
                                        <section class="otp-section otp-section-login"> 
                                            <form action="{{route('socialite.socialite_mobile_facebook',$facebook_user_id)}}" method="post">
                                                 @csrf
...
<script>
    $(document).ready(function () {
        $("#sendotp").click(function () {
            ...
            $.ajax({
                url: "/socialite/send_otp_facebook",
                data: {mobile: mobile,facebook_user_id:facebook_user_id},
                type: "GET",
...
<script>
    $(document).ready(function () {
        $("#resend_otp").click(function () {
            ...
            var facebook_user_id = $("#facebook_user_id").val();
            $.ajax({
                url: "/socialite/resend_otp_facebook",
                data: {mobile: mobile,facebook_user_id:facebook_user_id},
                type: "GET",
                success: function (data){
                    if(data == 'Unauthorised User'){
