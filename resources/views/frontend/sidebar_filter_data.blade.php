...
?>
                ...
                <img src="{{asset('/product_image/images/'.$product_image->provided_by.'/'.$product_image->PhotoFile_Name)}}"
                    class="img-responsive category_image" alt="Nestor Immunity Care" style="height: 190px">
                @else
...
?>
        ...
        <div class="dia-bottom plus_minus_button{{$product->id}}">
            ...
            <span style="color: #eb3b65">Out of Stock &nbsp;&nbsp;
                <button class="book-now-cart" type="button" onclick="notify_me_function({{$product->id}})"> Notify
                    Me</button>
            </span>
            @endif
            @else
