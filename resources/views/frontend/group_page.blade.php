...
<div class="main-div">
    <div class="container-fluid">
        <div class="row">
            ...
            @include('frontend.include.group_sidebar_filter')
            <div class="col-md-10">
            <div class="">
                    <div class="">
                        ...
                        <div class="sort-by-div">
                            ...
                            <div class="sort-by-flter">
                                ...
                                <span><a href="{{route('frontend.group_page',$single_group->url_name)}}?sort=ASC">Low To
                                        High</a></span>
                                <span><a href="{{route('frontend.group_page',$single_group->url_name)}}?sort=DISCOUNT">Discount</a></span>
                            </div>
                        </div>
                    </div>
...
?>
                                    ...
                                    <img src="{{asset('NoImage.webp')}}" class="img-responsive category_image"
                                        alt="Nestor Immunity Care" style="height: 190px">
                                    @endif
                                    @else
                                    <img src="{{asset('NoImage.webp')}}" class="img-responsive category_image"
                                        alt="Nestor Immunity Care" style="height: 190px">
