...
?>
 ...
 <h5>QTY:- </h5>
                                                                @if($add_cart_data->doctor_description_id != 1)
...
?>
                <div class="col-md-4">
                    <div>
                        <div class="totalamt-col">
                            ...
                            @if($check_amount > $order_setting->MinimumOrderValueForCustomer)
            ...
            @else
            <div>
                <img src="{{asset('empty_cart.png')}}" style="width: 100%">
...
function remove{{$add_cart_data->product_id}}_function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var cart_total_charge = cart_sub_total + gst_amount_value + 50;
