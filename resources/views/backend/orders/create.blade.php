      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Add New Offer Detail</h3>
            ...
            <div class="row">
              <div class="col-md-12">
                        ...
                        <div class="form-group{{ $errors->has('generic_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="generic_name" type="text" class="form-control" name="generic_name" value="{{ old('generic_name') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('brand_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="name" type="text" class="form-control" name="brand_name" value="{{ old('brand_name') }}" required autofocus>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10"> 
                                <select id="groupcategory_id" class="form-control" name="groupcategory_id"  required autofocus>
                                    {!!$groupcategoriesOp!!}
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('manufacture') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="manufacture" type="text" class="form-control" name="manufacture" value="{{ old('manufacture') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('composition') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="composition" type="text" class="form-control" name="composition" value="{{ old('composition') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('storage') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="storage" type="text" class="form-control" name="storage" value="{{ old('storage') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('OrderQtyMultipleOf') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="OrderQtyMultipleOf" type="text" class="form-control" name="OrderQtyMultipleOf" value="{{ old('OrderQtyMultipleOf') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('package_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">                               
                                <select id="package_id" class="form-control" name="package_id" value="{{ old('package_id') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('mrp_amount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="mrp_amount" type="text" class="form-control" name="mrp_amount" value="{{ old('mrp_amount') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('actual_amount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="actual_amount" type="text" class="form-control" name="actual_amount" value="{{ old('actual_amount') }}" required autofocus>
