...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Update Payment Gateway</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Update Payment Gateway</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Update New Payment Gateway Detail</h3>
                            ...
                            <div class="form-group{{ $errors->has('PaymentGateway_Code') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input id="PaymentGateway_Code" type="text" class="form-control"
                                        name="PaymentGateway_Code" value="{{$payment_gateway->PaymentGateway_Code}}"
                                        required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('PaymentGateway_Name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input id="PaymentGateway_Name" type="text" class="form-control"
                                        name="PaymentGateway_Name" value="{{$payment_gateway->PaymentGateway_Name}}"
                                        required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('PaymentGateway_MKey') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input id="PaymentGateway_MKey" type="text" class="form-control"
                                        name="PaymentGateway_MKey" value="{{$payment_gateway->PaymentGateway_MKey}}"
                                        required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('PaymentGateway_MId') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input id="PaymentGateway_MId" type="text" class="form-control"
                                        name="PaymentGateway_MId" value="{{$payment_gateway->PaymentGateway_MId}}"
                                        required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('PaymentGateway_MWebsite') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input id="PaymentGateway_MWebsite" type="text" class="form-control"
                                        name="PaymentGateway_MWebsite"
                                        value="{{$payment_gateway->PaymentGateway_MWebsite}}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('PaymentGateway_Channel') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input id="PaymentGateway_Channel" type="text" class="form-control"
                                        name="PaymentGateway_Channel"
                                        value="{{$payment_gateway->PaymentGateway_Channel}}" required autofocus>
                            ...
                            <div
                                ...
                                <div class="col-md-12">
                                    <input id="PaymentGateway_IndustryType" type="text" class="form-control"
                                        ...
                                        value="{{$payment_gateway->PaymentGateway_IndustryType}}" required autofocus>
                            ...
                            <div
                                ...
                                <div class="col-md-12">
                                    <input id="PaymentGateway_Callback_Url" type="text" class="form-control"
                                        ...
                                        value="{{$payment_gateway->PaymentGateway_Callback_Url}}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('PaymentGateway_Mode') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input id="PaymentGateway_Mode" type="text" class="form-control"
                                        name="PaymentGateway_Mode" value="{{$payment_gateway->PaymentGateway_Mode}}"
                                        required autofocus>
