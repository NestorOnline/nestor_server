            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Update Doctor Specialization</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('Doctor_Type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                    <select id="Doctor_Type" name="Doctor_Type" class="form-control" required autofocus>
                                        ...
                                        <option value="1" {{'1'==$doctor_specialization->Doctor_Type? 'selected':''}}>
                                            Allopathic</option>
                                        <option value="2" {{'2'==$doctor_specialization->Doctor_Type? 'selected':''}}>
                                            Ayurvedic</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group{{ $errors->has('Specialization_Type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                    <select id="Specialization_Type" name="Specialization_Type" class="form-control"
                                        ...
                                        <option value="">---- Select -----</option>
                                        <option value="1"
                                            {{'1'==$doctor_specialization->Specialization_Type? 'selected':''}}>
                                            General Physician</option>
                                        <option value="2"
                                            {{'2'==$doctor_specialization->Specialization_Type? 'selected':''}}>
                                            Specialities</option>
                                        <option value="3"
                                            {{'3'==$doctor_specialization->Specialization_Type? 'selected':''}}>
                                            Common Health Issue</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group{{ $errors->has('Specialization Name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                    <input id="name" type="text" class="form-control" name="Specialization_Name"
                                        value="{{$doctor_specialization->Specialization_Name}}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('icon_image') ? ' has-error' : '' }}">
                                <label for="icon_image" class="col-md-2 control-label">Product Image (Image Size: 200 ×
                                    200)</label>
                                <div class="col-md-10">
                                    <input id="icon_image" type="file" class="form-control" name="icon_image" autofocus>
